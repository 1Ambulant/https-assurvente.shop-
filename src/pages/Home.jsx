    ...
    <div className="space-y-6 animate-fade-in">
      <section className="relative bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-3xl p-6 shadow-xl overflow-hidden">
        ...
        <div className="relative">
          ...
          <Link to="/urgence">
            <button className="w-full bg-orange-500 hover:bg-orange-400 text-white p-4 rounded-2xl font-bold flex items-center justify-center gap-2 active:scale-95 transition-all shadow-lg shadow-orange-900/50 mt-4">
              ...
              {options.map((opt) => (
                <button key={opt.quote_id} onClick={() => chooseOption(opt.quote_id)} disabled={loading}
                  ...
                  <div className="space-y-1 text-xs text-gray-600">
                    ...
                    <p className="flex justify-between"><span>{opt.vendeur_nom}</span> <span>{opt.mode_recuperation === "mecano_recupere" ? "Mecano recupere" : "Livraison"}</span></p>
